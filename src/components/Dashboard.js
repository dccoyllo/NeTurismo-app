            ...
            <div className="p-grid p-fluid dashboard">
                ...
                <div className="p-col-12 p-md-6 p-xl-6">
                    <div className="highlight-box">
                        <div className="initials" style={{backgroundColor:'#007be5',color:'#00448f'}}><span>Agencias</span></div>
                        <div className="highlight-details ">
                            <i className="pi pi-search"/>
                            <span>Total de Agencias</span>
                            <span className="count">25</span>
                        </div>
                    </div>
                </div>
                <div className="p-col-4 p-md-6 p-xl-6">
                    <div className="highlight-box">
                        <div className="initials" style={{backgroundColor:'#ef6262',color:'#a83d3b'}}><span>Categorias</span></div>
                        <div className="highlight-details ">
                            <i className="pi pi-question-circle"/>
                            <span>numero de categorias</span>
